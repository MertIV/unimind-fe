...
class _OnboardingWidgetState extends State<OnboardingWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: UnimindMainTheme.of(context).primaryBackground,
        appBar: AppBar(
          backgroundColor: UnimindMainTheme.of(context).primaryBackground,
          automaticallyImplyLeading: false,
          title: Text(
            'Welcome',
            style: UnimindMainTheme.of(context).displaySmall,
          ),
          actions: const [],
          centerTitle: false,
          elevation: 0.0,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'Header One',
                                          style: UnimindMainTheme.of(context)
                                              .headlineMedium,
                                        ),
                                      ],
                                    ),
                        ...
                        child: Padding(
                          ...
                          child: smooth_page_indicator.SmoothPageIndicator(
                            ...
                            effect: smooth_page_indicator.ExpandingDotsEffect(
                              ...
                              dotWidth: 16.0,
                              dotHeight: 4.0,
                              dotColor: UnimindMainTheme.of(context).lineColor,
                              activeDotColor:
                                  UnimindMainTheme.of(context).primaryText,
