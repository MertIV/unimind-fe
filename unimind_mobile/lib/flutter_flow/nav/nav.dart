        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'Meetings',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'meetings')
                  : MeetingsWidget(),
            ),
            FFRoute(
              name: 'Profile',
            ...
            FFRoute(
              ...
              path: 'verificationPin',
              builder: (context, params) => VerificationPinWidget(
                loginOrRegister:
                    params.getParam('loginOrRegister', ParamType.double),
              ),
            ),
            FFRoute(
              name: 'Chat',
            ...
            FFRoute(
              name: 'Questionarre',
              path: 'questionarre',
              builder: (context, params) => QuestionarreWidget(),
            ),
            FFRoute(
              name: 'PaymentMethodList',
              path: 'paymentMethodList',
              builder: (context, params) => PaymentMethodListWidget(),
            ),
            FFRoute(
              name: 'EditProfile',
              path: 'editProfile',
            ...
            FFRoute(
              name: 'SuggestedMeetings',
              path: 'suggestedMeetings',
              builder: (context, params) => SuggestedMeetingsWidget(),
            )
