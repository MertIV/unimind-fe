...
abstract class UnimindMainTheme {
  static UnimindMainTheme of(BuildContext context) {
...
class LightModeTheme extends UnimindMainTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color secondary = const Color(0xFF6AD1FF);
