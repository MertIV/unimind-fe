                      ...
                      child: InkWell(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(12, 2, 0, 0),
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'y9078l28' /* Ödeme Seçenekleri */,
                                ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'wqlc8v1p' /* Arkadaşlarını Davet Et */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyText2
                                  .override(
