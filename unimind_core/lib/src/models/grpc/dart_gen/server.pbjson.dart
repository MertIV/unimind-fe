...
final $typed_data.Uint8List countResponseDescriptor = $convert.base64Decode('Cg1Db3VudFJlc3BvbnNlEhQKBWNvdW50GAEgASgDUgVjb3VudA==');
...
@$core.Deprecated('Use byteListResponseDescriptor instead')
const ByteListResponse$json = const {
  '1': 'ByteListResponse',
  '2': const [
...
/// Descriptor for `ByteListResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List byteListResponseDescriptor = $convert.base64Decode('ChBCeXRlTGlzdFJlc3BvbnNlEhIKBGRhdGEYASABKAxSBGRhdGE=');
