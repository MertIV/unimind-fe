...
class User extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'User', createEmptyInstance: create)
    ...
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentInfoIdList')
    ...
    ..pc<Question>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userMetadata', $pb.PbFieldType.PM, subBuilder: Question.create)
  ...
  factory User({
    ...
    $core.String? email,
    $core.String? phone,
    $core.Iterable<$core.String>? paymentInfoIdList,
    $core.String? fullname,
    $6.Timestamp? birthDate,
    UserType? type,
    $core.Iterable<Question>? userMetadata,
    ...
    if (paymentInfoIdList != null) {
      _result.paymentInfoIdList.addAll(paymentInfoIdList);
    }
    if (fullname != null) {
  ...
  @$pb.TagNumber(4)
  $core.List<$core.String> get paymentInfoIdList => $_getList(3);
  ...
  @$pb.TagNumber(8)
  $core.List<Question> get userMetadata => $_getList(7);
